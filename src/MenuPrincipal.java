...
public class MenuPrincipal extends javax.swing.JFrame {
    ...
    //armamos el JSON para el login 
    String json = "{"
            + "\"correo\":\"" + correo + "\","
            + "\"password\":\"" + password + "\""
            + "}";
    //peticion HTTP POST
    String respuesta = ApiCliente.post("https://shrubs-calzone-decency.ngrok-free.dev/usuarios/login",json);
   System.out.println("LOGIN RESPONSE: " + respuesta);
   
if (respuesta != null && respuesta.contains("\"rol\":\"" + rol + "\"")) {
    try {
        JSONObject obj = new JSONObject(respuesta);
        // AQUÍ SE OBTIENE EL ID (Valida que el id concuerde con el rol para que abra la ventana que le correspona)
