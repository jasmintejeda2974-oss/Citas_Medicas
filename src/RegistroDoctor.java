...
public class RegistroDoctor extends javax.swing.JFrame {
    ...
    private void cargarEspecialidades() {
        try {
            String respuesta = ApiCliente.get("https://shrubs-calzone-decency.ngrok-free.dev/especialidades");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        try {
            ...
            String respuestaUsuario = ApiCliente.post("https://shrubs-calzone-decency.ngrok-free.dev/usuarios/registrar", usuarioJson);
            ...
            String respuestaDoctor = ApiCliente.post("https://shrubs-calzone-decency.ngrok-free.dev/doctores", doctorJson);
