...
public class RegistroDoctor extends javax.swing.JFrame {
    ...
    private void cargarEspecialidades() {
        try {
            String respuesta = ApiCliente.get("http://localhost:8081/especialidades");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        try {
            ...
            String respuestaUsuario = ApiCliente.post("http://localhost:8081/usuarios/registrar", usuarioJson);
            ...
            String respuestaDoctor = ApiCliente.post("http://localhost:8081/doctores", doctorJson);
