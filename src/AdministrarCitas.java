...
private void cargarCitas() {
        try {
            ...
            String respuesta = ApiCliente.get("http://localhost:8081/citas");
...
try {
            ...
            ApiCliente.put("http://localhost:8081/citas/estado/" + id + "/FINALIZADA");
...
try {
            ...
            ApiCliente.put("http://localhost:8081/citas/estado/" + id + "/CANCELADA");
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
     try {
            ...
            ApiCliente.put("http://localhost:8081/citas/estado/" + id + "/CONFIRMADA");
